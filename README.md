...
artık istediğiniz zaman discord dm deki mesajlarınızı toplu olarak sılebilirsiniz// tarayıcıdan discordu açın daha sonra silmek isteğiniz dm mesajına giderek console kısmından bu kod satırını yapıştırarak gelen ekranda get kısımlarına tıklayarak delete basın ve mesajlarınız otomatik olarak silinecektir 
